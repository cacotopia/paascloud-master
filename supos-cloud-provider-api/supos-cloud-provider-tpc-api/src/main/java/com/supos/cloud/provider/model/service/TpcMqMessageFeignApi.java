...
import com.supos.cloud.provider.model.service.hystrix.TpcMqMessageFeignApiHystrix;
 ...
 * @author walkman
 */
@FeignClient(value = "supos-cloud-provider-tpc", configuration = OAuth2FeignAutoConfiguration.class, fallback = TpcMqMessageFeignApiHystrix.class)
